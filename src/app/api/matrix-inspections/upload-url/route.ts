...
/**
 * Signed upload URL pública (sin cuenta de usuario, igual que
 * autocertificaciones) para que el inspector en planta suba la foto del
 * perfil o del calibrador directo a Storage desde su teléfono.
 */
