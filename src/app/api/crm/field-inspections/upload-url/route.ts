...
/**
 * Signed upload URL para que el navegador suba la foto de la inspección
 * directo a Storage — mismo patrón usado en el resto de la app para
 * esquivar el límite de tamaño de request de Vercel.
 */
